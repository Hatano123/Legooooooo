    ...
    def draw_main_screen(self):
        ...
        for flag_name, coords in button_coords.items(): # flag_name here is the English key
            ...
            if captured_image_path and os.path.exists(captured_image_path):
                ...
                # Use display_text for default button
                self.canvas.create_text(center_x, text_y, text=display_text, font=font_title2, fill="black", tags=(flag_name, "text_default"))
       
        # The self.canvas.lower(self.bg_canvas_id) call is now inside the background setting block
        # at the beginning of this function, so it's not needed here again.
